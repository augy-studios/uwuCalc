...
window.uwuEngineFitness = (() => {
    ...
    const ALIAS = {
        ...
        'one-rep-max-calculator': renderOneRepMax,
        'calories-burned-calculator': renderCaloriesBurned,
        'macro-calculator': renderMacro,
        'protein-calculator': renderProtein,
        'carbohydrate-calculator': renderCarbohydrate,
        'fat-intake-calculator': renderFatIntake,
        'pace-calculator': renderPace,
        'pregnancy-calculator': renderPregnancy,
        'pregnancy-conception-calculator': renderPregnancyConception,
        'pregnancy-weight-gain-calculator': renderPregnancyWeightGain,
        'due-date-calculator': renderDueDate,
        'period-calculator': renderPeriod,
        'ovulation-calculator': renderOvulation,
        'height-calculator': renderHeight,
        'sleep-calculator': renderSleep,
        'gfr-calculator': renderGFR,
        'bac-calculator': renderBAC,
        'weight-watcher-points-calculator': renderWeightWatcherPoints,
